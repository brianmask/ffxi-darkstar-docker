...
UPDATE zone_settings SET zoneip = '172.31.0.6' WHERE zonetype = '0';
UPDATE zone_settings SET zoneip = '172.31.0.7' WHERE zonetype = '1';
UPDATE zone_settings SET zoneip = '172.31.0.8' WHERE zonetype = '2';
UPDATE zone_settings SET zoneip = '172.31.0.9' WHERE zonetype = '3';
UPDATE zone_settings SET zoneip = '172.31.0.10' WHERE zonetype = '4';
UPDATE zone_settings SET zoneip = '172.31.0.11' WHERE zonetype = '5';
UPDATE zone_settings SET zoneip = '172.31.0.12' WHERE zonetype = '6';
