...
skillup_chance_multiplier=${skillup_chance_multiplier:-2.9}
craft_chance_multiplier=${craft_chance_multiplier:-29}
...
ENABLE_TOAU=${ENABLE_TOAU:-1;}
ENABLE_WOTG=${ENABLE_WOTG:-1;}
ENABLE_ACP=${ENABLE_ACP:-1;}
ENABLE_AMK=${ENABLE_AMK:-1;}
ENABLE_ASA=${ENABLE_ASA:-1;}
ENABLE_ABYSSEA=${ENABLE_ABYSSEA:-1;}
ENABLE_SOA=${ENABLE_SOA:-1;}
ENABLE_ROV=${ENABLE_ROV:-1;}
ENABLE_VOIDWATCH=${ENABLE_VOIDWATCH:-1;}
...
SNEAK_INVIS_DURATION_MULTIPLIER=${SNEAK_INVIS_DURATION_MULTIPLIER:-2;}

ENABLE_COP_ZONE_CAP=${ENABLE_COP_ZONE_CAP:-0;}
NUMBER_OF_DM_EARRINGS=${NUMBER_OF_DM_EARRINGS:-1;}
HOMEPOINT_TELEPORT=${HOMEPOINT_TELEPORT:-1;}
